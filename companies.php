      ...
      <div class="panel-body">
          <div class="datatable">
              <table class="table table-striped table-bordered">
                      ...
                      <?php
                      $company_query  = "select * from sp_company WHERE status !=0 ORDER BY id DESC";
                      ...
                      if (mysqli_num_rows($company_res) > 0) {
                          ...
                          while($company_row=mysqli_fetch_array($company_res)) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href='view-company?id=<?php echo $company_id ?>'><?php echo $company_names; ?></a>
                                  </td>
                                  ...
                                  <td width="15%">
                                      <div class="btn-group"><a href='edit-contact?id=<?php echo $company_id ?>'
                                          ...
                                          <?php } ?>
                                          <a href='view-company?id=<?php echo $company_id ?>'
